...
<html>
<head>
<link rel="stylesheet" type="text/css" charset="utf-8" media="screen" href="<c:url value="/css/form.css"/>"/>
</head>
<body>
			...
			<c:when test="${empty usuarioSession.usuario.nome}">
				<form id="form_login" action="autenticar" method="post">
	                ...
	                <fieldset> 
	                    ...
	                    <div> 
	                        <p><label for="usuario.login">Login:<br/></label> <input type="text" size="30" name="usuario.login" value="${usuario.login}" /></p>
	                    </div>
	                    <div>    
	                        <p><label for="usuario.senha">Senha:<br/></label> <input type="password" size="30" name="usuario.senha" value="${usuario.senha}" /></p>
	                    </div>
		                <div>
